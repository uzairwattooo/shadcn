...
export async function POST() {
    try {
        const returnUrl = `${process.env.NEXT_PUBLIC_APP_URL}/dashboard/connect?stripe=return`;
        const refreshUrl = `${process.env.NEXT_PUBLIC_APP_URL}/dashboard/connect?stripe=refresh`;
